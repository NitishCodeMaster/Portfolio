...
function Navigation() {
  ...
  >
    ...
    /* Desktop Nav */
          ...
          <div
    className={`hidden md:flex items-center gap-1 glass px-6 py-2 rounded-full transition-all duration-500 ${scrolled ? "shadow-lg shadow-purple-500/10 border-white/20" : "border-transparent bg-transparent"}`}
  >
            {navLinks.map((link) => <a
    key={link.name}
    href={link.href}
