...
const Orb = () => {
  return <div className="relative mb-6 h-44 w-44 md:h-52 md:w-52 flex items-center justify-center select-none drop-shadow-[0_0_45px_rgba(168,85,247,0.45)]" aria-hidden="true">
            {
    /* Concentric Multi-Ring Radiating System */
  }
            <div className="absolute -inset-6 rounded-full border border-purple-400/35 animate-ping" style={{ animationDuration: "6s" }} />
            <div className="absolute -inset-2 rounded-full border border-dashed border-indigo-300/45 animate-spin" style={{ animationDuration: "30s" }} />

            {
    /* Refractive Cyber Glass Center Frame */
  }
            <div className="absolute inset-0 rounded-full border border-white/15 bg-gradient-to-tr from-neutral-900 via-neutral-950 to-purple-800/35 shadow-[0_25px_70px_rgba(0,0,0,0.85),0_0_55px_rgba(168,85,247,0.28),inset_0_1px_2px_rgba(255,255,255,0.14)] backdrop-blur-xl" />
